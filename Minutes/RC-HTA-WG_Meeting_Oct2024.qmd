...
-   Gregory Chen
    -   Principal Statistician in HTA Statistics team, MSD; lead of HTA-R workstream in openstatsware
...
:::::: columns
::: {.column width="55%"}
![*In open-source, there is no lack of choices - “What to choose” is the issue!*](RC-HTA-WG_Meeting_Oct2024_files/workstream2_gfx.png)
:::
