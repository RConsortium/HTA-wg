...
#### Cataloging R Packages and other R Resources
...
- Engage the community in developing educational materials to demonstrate state of the art HTA analyses using R and the resources identified above.
- Educational materials should include meta-anaysis, economic modeling and decision analysis
- Identify and create, if necessary, the appropriate channels for promoting educational materals including, webinars, blog posts, and social media outreach
- demonstrate strategie for incorporating R into existing HTA workflows
...
- A self sustaining network of educational and promotional activities
